...
const GetSpeed = () => {
  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center w-full md:w-4/5 h-full'>
        ...
        <div className='justify-center'>
          <div className='grid gap-6 grid-cols-3 '>
            ...
            <article className={`${'bg-transparent p-5 md:p-10 text-center rounded-sm border-solid border-blue-600'}`}>
              ...
              <h5 className="font-bold text-sm md:text-base uppercase">Ping</h5>
            ...
            <article className={`${'bg-transparent  p-5 md:p-10 text-center rounded-sm border-solid border-blue-600'}`}>
              <BsDownload className='text-blue-600 text-xl md:text-4xl mb-8 md:mb-4'/>
              <h5 className="font-bold text-sm md:text-base uppercase">Download</h5>
              <small className="text-xl md:text-3xl text-gray-200">
            ...
            <article className={`${'bg-transparent p-5 md:p-10 text-center rounded-sm border-solid border-blue-600'}`}>
              <BsUpload className='text-blue-600 text-xl md:text-4xl mb-8 md:mb-4'/>
              <h5 className="font-bold text-sm md:text-sm uppercase">Upload</h5>
              <small className="text-xl md:text-3xl text-gray-200">
